...
class Base_Agent(object):
    ...
    def __init__(self, config):
        ...
        self.environment_title = "Overcooked_AI"
    ...
    def reset_game(self):
        ...
        self.state = self.environment.reset() #to be coded into environment
    ...
    def create_NN(self, input_dim, output_dim, key_to_use=None, override_seed=None, hyperparameters=None, CNN= False):
