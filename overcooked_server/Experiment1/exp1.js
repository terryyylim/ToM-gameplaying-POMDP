/* initialize jsPsych */
    ...
    //28 videos, but will have 30 once yes line 9 and yes line 10 have the 8cut.
    ...
    //   type: jsPsychPreload,
    //   images: all_images,
    //   video: ['video/instruction_video.mp4']
    // };
    ...
    var welcome = {
      ...
      stimulus: '<p style="text-align:center;width:700px;"> Welcome to the experiment! This study takes most people around 20 minutes to complete. Please complete it in one sitting.</p>',
      choices: [" "],
    ...
    for (var i = 0; i < videos.length; i++){
      ...
      if (i%4 == 0){
        var video_trial = {
          ...
          questions: [{prompt: 'Say "morally acceptable" or "morally unacceptable" and explain briefly why you made the decision', required: true}],
          data: {
            trial_category: "explanation",
