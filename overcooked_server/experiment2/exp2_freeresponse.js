...
var instructions3 = {
  type: jsPsychSurveyText,
  preamble: `
  <p>(Instructions 3 out of 4)</p>
  <p style="text-align:center;width:900px;">In each video, all 8 people will start out waiting in a line in front of one of the water sources. People can leave the line and head straight for the water source without waiting or they can stay waiting in line until it’s their turn to collect water.</p>
  <p style="text-align:center;width:900px;"> Before each scene begins, imagine that the players have to make a decision (without talking to each other) about how they will behave in that scene. The players get to see what the game map looks like and where the line forms, but not which position in the line they will occupy (they won’t know whether they are first, second… or last in line).  Each player has to decide whether they will definitely stay in line or take opportunities to leave the line and head directly for the water source. Players have to lock-in their choices and the game doesn’t let them change their strategy once it has been submitted.</p>
  <p style="text-align:center;width:900px;"> Answer the attention check question and press continue to start the experiment!</p> 
  `,
  questions:[{prompt: 'What decision do players have to make before each scene begins?', required: true, name: 'instructions3'}],
  data:{trial_category: "instructions"}
};
...
var instructions4 = {
  type: jsPsychSurveyText,
  preamble: `
  <p>(Instructions 4 out of 4)</p>
  <p style="text-align:center;width:900px;">With each video, you will be shown an image of the specific person who you should focus on. This is the only person who didn’t have to decide their strategy ahead of time. They get to look at the map and decide once the game starts what they will do. This is the person whose actions you will judge as morally acceptable or morally unacceptable.</p>
  ...
  <p style="text-align:center;width:900px;"> Feel free to watch the video many times, but please watch it at least once completely before you make your judgments! Answer the attention check question and press continue to start the experiment!</p> 
  `,
  questions:[{prompt: 'What is unique about the one person you will focus on to judge in each video?', required: true, name: 'instructions4'}],
  data:{trial_category: "instructions"}
};
...
for (var i = 0; i < videos.length; i++){
  ...
  var video_trial = {
    type: jsPsychSurveyText,
    preamble:'<p><video controls autoplay loop style="height:auto;width:600px;" src=' + videos[i] + '></video></p><p style="text-align:center;width:700px;">Judge the behavior of this player in the video.</p> <p><img src=' + matching_image[videos[i]] + '></img></p>',
    questions: [{prompt: 'Say "morally acceptable" or "morally unacceptable" and explain in detail why you made the decision', required: true}],
    data: {
