...
var videos = [
'video/no_line_1_1cut.mp4', 'video/no_line_1_3cut.mp4', 'video/no_line_1_8cut.mp4',
'video/no_line_2_1cut.mp4','video/no_line_2_4cut.mp4','video/no_line_2_8cut.mp4',
'video/no_line_3_1cut.mp4','video/no_line_3_3cut.mp4','video/no_line_3_8cut.mp4',
'video/maybe_line_4_1cut.mp4', 'video/maybe_line_4_4cut.mp4', 'video/maybe_line_4_8cut.mp4',
'video/maybe_line_5_1cut.mp4', 'video/maybe_line_5_4cut.mp4','video/maybe_line_5_8cut.mp4',
'video/maybe_line_6_1cut.mp4','video/maybe_line_6_3cut.mp4','video/maybe_line_6_8cut.mp4',
'video/yes_line_7_1cut.mp4','video/yes_line_7_4cut.mp4','video/yes_line_7_8cut.mp4',
'video/yes_line_8_1cut.mp4','video/yes_line_8_3cut.mp4','video/yes_line_8_8cut.mp4',
'video/yes_line_9_1cut.mp4','video/yes_line_9_3cut.mp4',
'video/yes_line_10_1cut.mp4','video/yes_line_10_3cut.mp4'];
...
var matching_image = {
  ...
  "video/no_line_1_3cut.mp4": "img/4.png",
  "video/no_line_1_8cut.mp4": "img/2.png",
  "video/no_line_2_1cut.mp4": "img/8.png",
  "video/no_line_2_4cut.mp4": "img/7.png",
  "video/no_line_2_8cut.mp4": "img/4.png",
  "video/no_line_3_1cut.mp4": "img/8.png",
  "video/no_line_3_3cut.mp4": "img/2.png",
  "video/no_line_3_8cut.mp4": "img/1.png",
  "video/maybe_line_4_1cut.mp4": "img/4.png",
  "video/maybe_line_4_4cut.mp4": "img/8.png",
  "video/maybe_line_4_8cut.mp4": "img/6.png",
  "video/maybe_line_5_1cut.mp4": "img/6.png",
  "video/maybe_line_5_4cut.mp4": "img/5.png",
  "video/maybe_line_5_8cut.mp4": "img/1.png",
  "video/maybe_line_6_1cut.mp4": "img/7.png",
  "video/maybe_line_6_3cut.mp4": "img/5.png",
  "video/maybe_line_6_8cut.mp4": "img/8.png",
  "video/yes_line_7_1cut.mp4": "img/1.png",
  "video/yes_line_7_4cut.mp4": "img/3.png",
  "video/yes_line_7_8cut.mp4": "img/8.png",
  "video/yes_line_8_1cut.mp4": "img/1.png",
  "video/yes_line_8_3cut.mp4": "img/2.png",
  "video/yes_line_8_8cut.mp4": "img/1.png",
  "video/yes_line_9_1cut.mp4": "img/7.png",
  "video/yes_line_9_3cut.mp4": "img/5.png",
  "video/yes_line_10_1cut.mp4": "img/2.png",
  "video/yes_line_10_3cut.mp4": "img/7.png"
};
...
var instructions3 = {
  ...
  <p style="text-align:center;width:900px;"> In each video, all 8 people will start out waiting in a line in front of one of the water sources. People can leave the line and head straight for the water source without waiting or they can stay waiting in line until it’s their turn to collect water. However, the videos you see will end shortly after the character makes a decision to leave or stay in the line. Your job is to make a judgment without seeing the level unfold, by thinking about what will happen!</p>
  ...
  `,
  questions:[{prompt: 'How many people are in the line when the level begins?', required: true, name: 'instructions4'}],
  data:{trial_category: "instructions"}
};
...
for (var i = 0; i < videos.length; i++){
  ...
  if (stim_name.includes("no")){
    if (stim_name.includes("no_line_1_1cut") || stim_name.includes("no_line_2_1cut") || stim_name.includes("no_line_3_1cut")){
      stim_category = "no_1"
    }
    else if (stim_name.includes("no_line_1_3cut") || stim_name.includes("no_line_2_4cut") || stim_name.includes("no_line_3_3cut")){
      stim_category = "no_34"
    }
    else{
      stim_category = "no_8"
    ...
    if (stim_name.includes("maybe_line_4_1cut") || stim_name.includes("maybe_line_5_1cut") || stim_name.includes("maybe_line_6_1cut")){
      stim_category = "maybe_1"
    }
    else if (stim_name.includes("maybe_line_4_4cut") || stim_name.includes("maybe_line_5_4cut") || stim_name.includes("maybe_line_6_3cut")){
      stim_category = "maybe_34"
    }
    else{
      stim_category = "maybe_8"
    }
  }

  else{
    if (stim_name.includes("1cut")){
      stim_category = "yes_1"
    }
    else if (stim_name.includes("3cut") || stim_name.includes("4cut")){
      stim_category = "yes_34"
    }
    else{
      stim_category = "yes_8"
    }
  ...
  var video_trial = {
    ...
    prompt: '<p style="text-align:center;width:700px;">Judge what this player is doing.</p> <p><img src=' + matching_image[videos[i]] + '></img></p>',
    data: {
