...
var instructions3 = {
  ...
  <p style="text-align:center;width:900px;"> In each video, all 8 people will start out waiting in a line in front of one of the water sources. People can leave the line and head straight for the water source without waiting, or they can stay waiting in line until it’s their turn to collect water. The videos you see will end shortly after just one character makes a decision to leave or stay in the line. Your job is to think about what would happen if EVERYONE felt at liberty to leave the line and try to get water faster for themselves, instead of everyone staying in line. Then, answer how much better or worse off everyone would be if everyone stayed in line.</p>
  ...
  `,
  questions:[{prompt: 'The video shows only one person leaving the line. You should think about what two cases?', required: true, name: 'instructions4'}],
  data:{trial_category: "instructions"}
};
...
for (var i = 0; i < videos.length; i++){
  ...
  if (i%3 == 2){
    var video_trial = {
      ...
      questions: [{prompt: '<p style="text-align:center;width:700px;"</p>What if everyone felt at liberty to leave the line and try to get water faster for themselves? How much better or worse off would everyone be compared to if they all stayed in line instead? State a number between -50 to 50, where -50 means everyone would be much worse off, 0 means about the same, and 50 means everyone would be much better off. Please explain your decision.', required: true, rows: 3}],
      data: {
    ...
    var video_trial = {
      ...
      stimulus: [videos[i]],
      labels: ['Much worse off', 'The same', 'Much better off'],
      response_allowed_while_playing: false,
      min: -50,
      max: 50,
      slider_start: 0,
      prompt: '<p style="text-align:center;width:700px;">What if everyone felt at liberty to leave the line and try to get water faster for themselves? How much better or worse off would everyone be compared to if they all stayed in line instead? Slide the bar to indicate your answer.</p>',
      data: {
        trial_category: stim_category,
        stimulus_name: videos[i]
      },
