    ...
    def new(
        ...
        for idx in range(1, self.player_count+1):
            ...
            if idx == '1':
                ...
                self.player_5 = Player(self, idx, players[idx]['coords'][1], players[idx]['coords'][0], players[idx]['holding'])
            elif idx == '6':
                self.player_6 = Player(self, idx, players[idx]['coords'][1], players[idx]['coords'][0], players[idx]['holding'])
